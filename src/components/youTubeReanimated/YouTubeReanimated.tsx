...
const bottomTranslateY = (screenHeight * 100) / 100 - IMAGE_WIDTH_COL - 20;

interface IYoutubePlayerProps {
  onClose: () => void;
  selectedVideo: IVideoCardProps;
}

const YoutubePlayer = ({ onClose, selectedVideo }: IYoutubePlayerProps) => {
  ...
  return (
    <Animated.View style={[translateStyle, styles.wrapper]}>
      ...
      <View style={styles.playerContainer}>
        ...
        <View style={[styles.iconsContainer, { width: (SIZES.width * 23) / 100 }]}>
